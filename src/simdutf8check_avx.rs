...
#![feature(stdsimd)]
#[cfg ( target_arch = "x86" )]
pub use std::arch::x86::{__m256i, _mm256_testz_si256, _mm256_loadu_si256,
                         _mm256_set_epi8, _mm256_setr_epi8, _mm256_set1_epi8,
                         _mm256_setzero_si256, _mm256_add_epi8,
                         _mm256_and_si256, _mm256_cmpeq_epi8,
                         _mm256_cmpgt_epi8, _mm256_or_si256,
                         _mm256_shuffle_epi8, _mm256_srli_epi16,
                         _mm256_subs_epu8, _mm256_alignr_epi8,
                         _mm256_permute2x128_si256};
#[cfg ( target_arch = "x86_64" )]
pub use std::arch::x86_64::{__m256i, _mm256_testz_si256, _mm256_loadu_si256,
                            _mm256_set_epi8, _mm256_setr_epi8,
                            _mm256_set1_epi8, _mm256_setzero_si256,
                            _mm256_add_epi8, _mm256_and_si256,
                            _mm256_cmpeq_epi8, _mm256_cmpgt_epi8,
                            _mm256_or_si256, _mm256_shuffle_epi8,
                            _mm256_srli_epi16, _mm256_subs_epu8,
                            _mm256_alignr_epi8, _mm256_permute2x128_si256};
extern "C" {
    #[no_mangle]
...
/* // all byte values must be no larger than 0xF4 */
 /* inline void checkSmallerThan0xF4(__m128i current_bytes, */
                                        /* __m128i *has_error) { */
...
/* inline __m128i continuationLengths(__m128i high_nibbles) { */
  /* return _mm_shuffle_epi8( */
      ...
      /* high_nibbles); */
/* } */
/* inline __m128i carryContinuations(__m128i initial_lengths, */
...
/* } */
/* inline void checkContinuations(__m128i initial_lengths, __m128i carries, */
                                      /* __m128i *has_error) { */
/* // overlap || underlap */
...
/* // next byte must be continuation, ie sign bit is set, so signed < is ok */
 /* inline void checkFirstContinuationMax(__m128i current_bytes, */
...
/* // F       => < F1 && < 90 */
/* // else      false && false */
 /* inline void checkOverlong(__m128i current_bytes, */
...
/* }; */
/* inline void count_nibbles(__m128i bytes, */
...
/* checkOverlong(current_bytes, off1_current_bytes, pb.high_nibbles, */
  ...
  /* return pb; */
/* } */
/* bool validate_utf8_fast(const char *src, size_t len) { */
  /* size_t i = 0; */
...
/* [>***************************<] */
#[inline]
unsafe extern "C" fn push_last_byte_of_a_to_b(mut a: __m256i, mut b: __m256i)
 -> __m256i {
    return _mm256_alignr_epi8(b,
                              _mm256_permute2x128_si256(a, b,
                                                        0x21 as libc::c_int),
                              15 as libc::c_int);
}
#[inline]
unsafe extern "C" fn push_last_2bytes_of_a_to_b(mut a: __m256i,
                                                mut b: __m256i) -> __m256i {
    return _mm256_alignr_epi8(b,
                              _mm256_permute2x128_si256(a, b,
                                                        0x21 as libc::c_int),
                              14 as libc::c_int);
...
// all byte values must be no larger than 0xF4
#[inline]
unsafe extern "C" fn avxcheckSmallerThan0xF4(mut current_bytes: __m256i,
                                             mut has_error: *mut __m256i) {
    // unsigned, saturates to 0 below max
    *has_error =
        _mm256_or_si256(*has_error,
                        _mm256_subs_epu8(current_bytes,
                                         _mm256_set1_epi8(0xf4 as libc::c_int
                                                              as
                                                              libc::c_char)));
}
#[inline]
unsafe extern "C" fn avxcontinuationLengths(mut high_nibbles: __m256i)
 -> __m256i {
    return _mm256_shuffle_epi8(_mm256_setr_epi8(1 as libc::c_int as
                                                    libc::c_char,
                                                1 as libc::c_int as
                                                    libc::c_char,
                                                1 as libc::c_int as
...
#[inline]
unsafe extern "C" fn avxcarryContinuations(mut initial_lengths: __m256i,
                                           mut previous_carries: __m256i)
 -> __m256i {
    let mut right1: __m256i =
        _mm256_subs_epu8(push_last_byte_of_a_to_b(previous_carries,
                                                  initial_lengths),
                         _mm256_set1_epi8(1 as libc::c_int as libc::c_char));
    let mut sum: __m256i = _mm256_add_epi8(initial_lengths, right1);
    let mut right2: __m256i =
...
#[inline]
unsafe extern "C" fn avxcheckContinuations(mut initial_lengths: __m256i,
                                           mut carries: __m256i,
                                           mut has_error: *mut __m256i) {
    // overlap || underlap
  // carry > length && length > 0 || !(carry > length) && !(length > 0)
  // (carries > length) == (lengths > 0)
    let mut overunder: __m256i =
...
// next byte must be continuation, ie sign bit is set, so signed < is ok
#[inline]
unsafe extern "C" fn avxcheckFirstContinuationMax(mut current_bytes: __m256i,
                                                  mut off1_current_bytes:
                                                      __m256i,
                                                  mut has_error:
                                                      *mut __m256i) {
    let mut maskED: __m256i =
        _mm256_cmpeq_epi8(off1_current_bytes,
                          _mm256_set1_epi8(0xed as libc::c_int as
                                               libc::c_char));
    let mut maskF4: __m256i =
        _mm256_cmpeq_epi8(off1_current_bytes,
                          _mm256_set1_epi8(0xf4 as libc::c_int as
                                               libc::c_char));
    let mut badfollowED: __m256i =
        _mm256_and_si256(_mm256_cmpgt_epi8(current_bytes,
                                           _mm256_set1_epi8(0x9f as
                                                                libc::c_int as
                                                                libc::c_char)),
                         maskED);
    let mut badfollowF4: __m256i =
        _mm256_and_si256(_mm256_cmpgt_epi8(current_bytes,
                                           _mm256_set1_epi8(0x8f as
                                                                libc::c_int as
                                                                libc::c_char)),
                         maskF4);
    *has_error =
        _mm256_or_si256(*has_error,
                        _mm256_or_si256(badfollowED, badfollowF4));
}
// map off1_hibits => error condition
// hibits     off1    cur
// C       => < C2 && true
...
// else      false && false
#[inline]
unsafe extern "C" fn avxcheckOverlong(mut current_bytes: __m256i,
                                      mut off1_current_bytes: __m256i,
                                      mut hibits: __m256i,
                                      mut previous_hibits: __m256i,
                                      mut has_error: *mut __m256i) {
    let mut off1_hibits: __m256i =
        push_last_byte_of_a_to_b(previous_hibits, hibits);
    let mut initial_mins: __m256i =
        _mm256_shuffle_epi8(_mm256_setr_epi8(-(128 as libc::c_int) as
                                                 libc::c_char,
                                             ...
                                             -(128 as libc::c_int) as
                                                 libc::c_char,
                                             0xc2 as libc::c_int as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                                 libc::c_char,
                                             0xe1 as libc::c_int as
                                                 libc::c_char,
                                             0xf1 as libc::c_int as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                             ...
                                             0xe1 as libc::c_int as
                                                 libc::c_char,
                                             0xf1 as libc::c_int as
                                                 libc::c_char), off1_hibits);
    let mut initial_under: __m256i =
        _mm256_cmpgt_epi8(initial_mins, off1_current_bytes);
    let mut second_mins: __m256i =
        _mm256_shuffle_epi8(_mm256_setr_epi8(-(128 as libc::c_int) as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                                 libc::c_char,
                                             ...
                                             127 as libc::c_int as
                                                 libc::c_char,
                                             0xa0 as libc::c_int as
                                                 libc::c_char,
                                             0x90 as libc::c_int as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                                 libc::c_char,
                                             -(128 as libc::c_int) as
                                             ...
                                             0x90 as libc::c_int as
                                                 libc::c_char), off1_hibits);
    let mut second_under: __m256i =
        _mm256_cmpgt_epi8(second_mins, current_bytes);
    *has_error =
        _mm256_or_si256(*has_error,
                        _mm256_and_si256(initial_under, second_under));
}
#[inline]
unsafe extern "C" fn avx_count_nibbles(mut bytes: __m256i,
                                       mut answer:
                                           *mut avx_processed_utf_bytes) {
    (*answer).rawbytes = bytes;
    (*answer).high_nibbles =
        _mm256_and_si256(_mm256_srli_epi16(bytes, 4 as libc::c_int),
                         _mm256_set1_epi8(0xf as libc::c_int as
                                              libc::c_char));
}
// check whether the current bytes are valid UTF-8
// at the end of the function, previous gets updated
#[no_mangle]
pub unsafe extern "C" fn avxcheckUTF8Bytes(mut current_bytes: __m256i,
                                           mut previous:
                                               *mut avx_processed_utf_bytes,
                                           mut has_error: *mut __m256i)
 -> avx_processed_utf_bytes {
    let mut pb: avx_processed_utf_bytes =
        avx_processed_utf_bytes{rawbytes: _mm256_setzero_si256(),
                                high_nibbles: _mm256_setzero_si256(),
                                carried_continuations:
                                    _mm256_setzero_si256(),};
    avx_count_nibbles(current_bytes, &mut pb);
    avxcheckSmallerThan0xF4(current_bytes, has_error);
    let mut initial_lengths: __m256i =
        avxcontinuationLengths(pb.high_nibbles);
    pb.carried_continuations =
        avxcarryContinuations(initial_lengths,
                              (*previous).carried_continuations);
    avxcheckContinuations(initial_lengths, pb.carried_continuations,
                          has_error);
    let mut off1_current_bytes: __m256i =
        push_last_byte_of_a_to_b((*previous).rawbytes, pb.rawbytes);
    avxcheckFirstContinuationMax(current_bytes, off1_current_bytes,
                                 has_error);
...
// at the end of the function, previous gets updated
#[no_mangle]
pub unsafe extern "C" fn avxcheckUTF8Bytes_asciipath(mut current_bytes:
                                                         __m256i,
                                                     mut previous:
                                                         *mut avx_processed_utf_bytes,
                                                     mut has_error:
...
#[no_mangle]
pub unsafe extern "C" fn validate_utf8_fast_avx_asciipath(mut src:
                                                              *const libc::c_char,
                                                          mut len: size_t)
 -> bool {
    ...
    if len >= 32 as libc::c_int as libc::c_ulong {
        while i <= len.wrapping_sub(32 as libc::c_int as libc::c_ulong) {
            ...
            previous =
                avxcheckUTF8Bytes_asciipath(current_bytes, &mut previous,
                                            &mut has_error);
            i =
                (i as
                     libc::c_ulong).wrapping_add(32 as libc::c_int as
    ...
    if i < len {
        ...
        previous =
            avxcheckUTF8Bytes(current_bytes_0, &mut previous, &mut has_error)
    } else {
        has_error =
            _mm256_or_si256(_mm256_cmpgt_epi8(previous.carried_continuations,
                                              _mm256_setr_epi8(9 as
...
#[no_mangle]
pub unsafe extern "C" fn validate_utf8_fast_avx(mut src: *const libc::c_char,
                                                mut len: size_t) -> bool {
    let mut i: size_t = 0 as libc::c_int as size_t;
    let mut has_error: __m256i = _mm256_setzero_si256();
    let mut previous: avx_processed_utf_bytes =
    ...
    if len >= 32 as libc::c_int as libc::c_ulong {
        while i <= len.wrapping_sub(32 as libc::c_int as libc::c_ulong) {
            let mut current_bytes: __m256i =
                _mm256_loadu_si256(src.offset(i as isize) as *const __m256i);
            previous =
                avxcheckUTF8Bytes(current_bytes, &mut previous,
                                  &mut has_error);
            i =
                (i as
                     libc::c_ulong).wrapping_add(32 as libc::c_int as
